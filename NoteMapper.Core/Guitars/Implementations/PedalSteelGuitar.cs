namespace NoteMapper.Core.Guitars.Implementations
{
    public class PedalSteelGuitar : GuitarBase
    {
        ...
        {
            List<GuitarStringModifier> modifiers = new List<GuitarStringModifier>();
            ...
            List<GuitarString> strings = new List<GuitarString>();
            ...
            GuitarStringModifierCollection modifierCollection = new GuitarStringModifierCollection(modifiers,
